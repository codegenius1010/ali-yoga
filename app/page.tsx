      ...
      <main>
        ...
        <Section size="lg" background="white">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Left: Image */}
            <div className="h-96 rounded-2xl flex items-center justify-center overflow-hidden">
              <img
                src="/images/home-hero-yoga-golf.png"
        ...
        <Section size="lg" background="cream">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Right: Image */}
            <div className="h-96 rounded-2xl flex items-center justify-center overflow-hidden order-first lg:order-last">
              <img
                src="/images/AliHeadshot.webp"
                alt="Ali - Yoga Instructor"
                className="w-full h-full object-cover"
              />
            </div>
          </div>
